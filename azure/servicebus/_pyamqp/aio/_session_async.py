...
class Session(object):  # pylint: disable=too-many-instance-attributes
    ...
    async def _incoming_begin(self, frame):
        ...
        self.handle_max = frame[4] if len(frame) > 4 else 4294967295  # handle_max
        ...
        self.remote_properties = frame[7] if len(frame) > 7 else None  # incoming map of properties about the session
